    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
         <form class="form-horizontal form-label-left "  id="addForm" method="post" action="{{route('franchise.importdata')}}" enctype="multipart/form-data">
        @csrf

        	<div class="item form-group">
	            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="xfile">Import file <span class="required">*</span>
	            </label>
